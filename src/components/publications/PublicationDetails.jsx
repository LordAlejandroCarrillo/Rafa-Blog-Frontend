                ...
                <div className="card shadow" style={{ backgroundColor: '#000039', color: 'white' }}>
                  <div className="card-body text-start">
                    ...
                    <div className="accordion mt-4 mx-3" id={`accordion-${id}`}>
                      <div className="accordion-item" style={{ backgroundColor: '#000039', color: 'white', border: '1px solid rgba(255,255,255,0.2)' }}>
                        ...
                        >
                          <div className="accordion-body">
                            <form onSubmit={handleSubmit}>
                              ...
                              <div class="mb-3">
                                <textArea type="text" className="form-control mb-2" placeholder="Write your comment here..." value={text} onChange={(e) => setText(e.target.value)}/>
                              </div>
